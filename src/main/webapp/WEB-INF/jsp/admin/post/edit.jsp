...
<c:set var="pagetitle" value="Post Edit"></c:set>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class='wrapper'>
    <div class="hero">
        ...
        <div class="container" style="width: 800px">
            <form action="<c:url value="/admin/post/edit"/>" method="post" >
                <input type="hidden" value="${post.id}" id="id" name="id">
                <label for="title">Title</label>
                <input type="text" id="title" value="${post.title}" name="title" placeholder="Your post title..">
                <label for="details">Details</label>
                <textarea id="details" name="details" placeholder="Write something.." style="height:200px">${post.details}</textarea>
